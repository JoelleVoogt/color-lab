...
export default function ColorOutput() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-9 gap-2 max-w-7xl w-full my-8">
      <ColorVariable scale="100" value="#F6DDD5" text="black" />
      <ColorVariable scale="200" value="#ECBCAC" text="black" />
      <ColorVariable scale="300" value="#E39A82" text="black" />
      <ColorVariable scale="400" value="#D97757" text="black" />
      <ColorVariable scale="500" value="#C96442" text="black" />
